...
public class ReaderSAXTest {
    ...
    @Test
    public void equalsReadContentFromXMLByReaderSAX() {
        ReaderSAX readerSAX = new ReaderSAX(XMLConstants.VALID_XML_FILE);
        Flowers flowers = readerSAX.getFlowers();
